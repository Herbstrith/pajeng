...
int rastroIgnoreIncompleteLinks = 0;

PajeRastroSimulator::PajeRastroSimulator ()
{
...
PajeRastroSimulator::PajeRastroSimulator (double stopat)
{
  useRastroEvent = false;
...
PajeRastroSimulator::PajeRastroSimulator (double stopat, int ignore)
{
  useRastroEvent = false;
  stopSimulationAtTime = stopat;
  rastroIgnoreIncompleteLinks = ignore;
  init ();
}

PajeRastroSimulator::PajeRastroSimulator (bool setRastroEvent)
{
...
void PajeRastroSimulator::init (void)
{
  invocation[PajeDefineContainerTypeEventId] = &PajeRastroSimulator::pajeDefineContainerType;
  invocation[PajeDefineLinkTypeEventId] = &PajeRastroSimulator::pajeDefineLinkType;
  invocation[PajeDefineEventTypeEventId] = &PajeRastroSimulator::pajeDefineEventType;
  invocation[PajeDefineStateTypeEventId] = &PajeRastroSimulator::pajeDefineStateType;
  invocation[PajeDefineVariableTypeEventId] = &PajeRastroSimulator::pajeDefineVariableType;
  invocation[PajeDefineEntityValueEventId] = &PajeRastroSimulator::pajeDefineEntityValue;
  invocation[PajeCreateContainerEventId] = &PajeRastroSimulator::pajeCreateContainer;
  invocation[PajeDestroyContainerEventId] = &PajeRastroSimulator::pajeDestroyContainer;
  invocation[PajeNewEventEventId] = &PajeRastroSimulator::pajeNewEvent;
  invocation[PajeSetStateEventId] = &PajeRastroSimulator::pajeSetState;
  invocation[PajePushStateEventId] = &PajeRastroSimulator::pajePushState;
  invocation[PajePopStateEventId] = &PajeRastroSimulator::pajePopState;
  invocation[PajeResetStateEventId] = &PajeRastroSimulator::pajeResetState;
  invocation[PajeSetVariableEventId] = &PajeRastroSimulator::pajeSetVariable;
  invocation[PajeAddVariableEventId] = &PajeRastroSimulator::pajeAddVariable;
  invocation[PajeSubVariableEventId] = &PajeRastroSimulator::pajeSubVariable;
  invocation[PajeStartLinkEventId] = &PajeRastroSimulator::pajeStartLink;
  invocation[PajeEndLinkEventId] = &PajeRastroSimulator::pajeEndLink;
...
void PajeRastroSimulator::report (void)
{
...
bool PajeRastroSimulator::keepSimulating (void)
{
...
void PajeRastroSimulator::setLastKnownTime (PajeTraceEvent *event)
{
  if(!useRastroEvent)
  {
...
PajeColor *PajeRastroSimulator::getColor (std::string color, PajeTraceEvent *event)
{
  PajeColor *ret = NULL;
  if (!color.empty()){
    std::vector<float> v;
...
void PajeRastroSimulator::inputEntity (PajeObject *data)
{  
...
void PajeRastroSimulator::startReading (void)
{
}

void PajeRastroSimulator::finishedReading (void)
{
...
void PajeRastroSimulator::pajeDefineContainerType (PajeTraceEvent *event)
{
  std::string name;
  std::string type;
  std::string alias;
...
void PajeRastroSimulator::pajeDefineLinkType (PajeTraceEvent *event)
{
  std::string name;
  std::string type;
  ...
  name = RastrotraceEvent->valueForStringField (PAJE_Name);
  type = RastrotraceEvent->valueForStringField (PAJE_Type);
  starttype = RastrotraceEvent->valueForStringField (PAJE_StartContainerType);
  endtype = RastrotraceEvent->valueForStringField (PAJE_EndContainerType);
  alias = RastrotraceEvent->valueForStringField (PAJE_Alias);
...
void PajeRastroSimulator::pajeDefineEventType (PajeTraceEvent *event)
{
  std::string name;
  std::string type;
  std::string alias;
...
void PajeRastroSimulator::pajeDefineStateType (PajeTraceEvent *event)
{
  std::string name;
  std::string type;
  std::string alias;
...
void PajeRastroSimulator::pajeDefineVariableType (PajeTraceEvent *event)
{
  std::string name;
  std::string type;
  std::string alias;
...
void PajeRastroSimulator::pajeDefineEntityValue (PajeTraceEvent *event)
{
  std::string name;
  std::string typestr;
  std::string alias;
...
void PajeRastroSimulator::pajeCreateContainer (PajeTraceEvent *traceEvent)
{
  std::string time;
  std::string typestr;
...
void PajeRastroSimulator::pajeDestroyContainer (PajeTraceEvent *traceEvent)
{
  std::string time;
  std::string type;
  std::string name;
...
void PajeRastroSimulator::pajeNewEvent (PajeTraceEvent *traceEvent)
{
  std::string time;
  std::string typestr;
  ...
  value = RastrotraceEvent->valueForStringField (PAJE_Value);
...
void PajeRastroSimulator::pajeSetState (PajeTraceEvent *traceEvent)
{
...
void PajeRastroSimulator::pajePushState (PajeTraceEvent *traceEvent)
{
  std::string time;
  std::string typestr;
  std::string containerstr;
...
void PajeRastroSimulator::pajePopState (PajeTraceEvent *traceEvent)
{
...
void PajeRastroSimulator::pajeResetState (PajeTraceEvent *traceEvent)
{
  std::string time;
  std::string typestr;
  std::string containerstr;
...
void PajeRastroSimulator::pajeSetVariable (PajeTraceEvent *traceEvent)
{
  std::string time;
  std::string typestr;
  std::string containerstr;
  ...
  typestr = RastrotraceEvent->valueForStringField (PAJE_Type);
  containerstr = RastrotraceEvent->valueForStringField (PAJE_Container);
  v = RastrotraceEvent->valueForDoubleField (PAJE_Value);
...
void PajeRastroSimulator::pajeAddVariable (PajeTraceEvent *traceEvent)
{
  std::string time;
  std::string typestr;
  std::string containerstr;
...
void PajeRastroSimulator::pajeSubVariable (PajeTraceEvent *traceEvent)
{
  std::string time;
  std::string typestr;
  std::string containerstr;
...
void PajeRastroSimulator::pajeStartLink (PajeTraceEvent *traceEvent)
{
  std::string time;
  std::string typestr;
  std::string containerstr;
  std::string startcontainerstr;
  std::string value;
  std::string key;
  float v;
  ...
  typestr = RastrotraceEvent->valueForStringField (PAJE_Type);
  containerstr = RastrotraceEvent->valueForStringField (PAJE_Container);
  startcontainerstr = RastrotraceEvent->valueForStringField (PAJE_StartContainer);
  value = RastrotraceEvent->valueForStringField (PAJE_Value);
  key = RastrotraceEvent->valueForStringField (PAJE_Key);
...
void PajeRastroSimulator::pajeEndLink (PajeTraceEvent *traceEvent)
{
  std::string time;
  std::string typestr;
  std::string containerstr;
  std::string endcontainerstr;
  std::string value;
  std::string key;
  ...
  typestr = RastrotraceEvent->valueForStringField (PAJE_Type);
  containerstr = RastrotraceEvent->valueForStringField (PAJE_Container);
  endcontainerstr = RastrotraceEvent->valueForStringField (PAJE_EndContainer);
  value = RastrotraceEvent->valueForStringField (PAJE_Value);
  key = RastrotraceEvent->valueForStringField (PAJE_Key);
